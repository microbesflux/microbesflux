...
public class TopPanel extends HorizontalPanel{
	...
	public TopPanel(final WorkPanel workPanel){
		...
		paneLink.setContents("<a href=\"http://www.genome.jp/kegg/catalog/org_list.html\" target=\"_blank\">KEGG Organisms</a>");  
		...
		buttonRun.addClickHandler(new ClickHandler(){
			public void onClick(ClickEvent event) {
				id = suggestBox.getText().split(" ")[0];
				workPanel.sendGenomicInformation(id);
				workPanel.changeToGenome();
			}
		});
		buttonRun.setText("Run");
		buttonRun.setSize("60px", "30px");
	
		this.add(layoutpaneLink);
		this.add(panel);
		this.add(buttonRun);
	}
}
