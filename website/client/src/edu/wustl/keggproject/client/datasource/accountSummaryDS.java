...
public class accountSummaryDS extends RestDataSource{
	...
	private accountSummaryDS(String id)
	{
		...
		DataSourceField date 		  = new DataSourceField("date", FieldType.TEXT, "Date");
		DataSourceField model     = new DataSourceField("model", FieldType.TEXT, "Model");
		DataSourceField type = new DataSourceField("type", FieldType.TEXT, "Type");
